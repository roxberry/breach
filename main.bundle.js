...
module.exports = "<div class=\"card mb-3\">\n    <div class=\"card-body\">\n        <div class=\"card-title row justify-content-between\"><h4 class=\"col-8\">{{title}}</h4><button (click)=\"resetZoom()\" class=\"col-2 mr-4\">Reset View</button></div>\n        <chart class=\"breach-chart\" [type]=\"type\" [data]=\"data\" [options]=\"options\"></chart>\n    </div>\n</div>"
...
var BreachChartComponent = (function () {
    ...
    BreachChartComponent.prototype.loadScatterPlot = function (title, formula, dataset) {
        this.title = title;
        this.formulaValue = formula.formulaValue;
        this.type = 'scatter';
        var mapdata = [];
    ...
    BreachChartComponent.prototype.onAnimationComplete = function () {
        ...
        if (this.chart.data != undefined && this.chart.data.datasets.length > 0) {
            ...
            meta.data.forEach(function (element) {
                ...
                _this.chart.chart.ctx.fillText(ds.data[element._index].dam, element._model.x + 5, element._model.y - 5);
            });
        }
        //this.chart.chart.resetZoom();
    };
    ...
    BreachChartComponent.prototype.loadFormula = function (formula) {
        ...
        this.chartService.getDataset(formula.datasetPath).then(function (dataset) {
            if (formula.variables.usesHeight && formula.variables.usesVolume) {
                ...
                _this.loadScatterPlot(dataset['datasets'][0].label, formula, dataset);
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_mathjs__ = __webpack_require__("../../../../mathjs/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_mathjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_mathjs__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FormulaeComponent = (function () {
    function FormulaeComponent(formulaeService, chartService, http) {
        this.formulaeService = formulaeService;
        this.chartService = chartService;
        this.http = http;
    }
    FormulaeComponent.prototype.getFormulae = function () {
        ...
        this.formulaeService.getFormulae().then(function (formulae) {
            ...
            _this.selectedFormula = _this.formulae[0];
